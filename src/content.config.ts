...
const common = { title: z.string().min(3), title_vi: z.string().optional(), description: z.string().min(10), description_vi: z.string().optional(), date: z.coerce.date(), draft: z.boolean().default(false), featured: z.boolean().default(false), order: z.number().int().default(99), topics: z.array(slug).default([]) };
